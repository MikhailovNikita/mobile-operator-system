        ...
        <div id="cm-menu-items-wrapper">
            <div id="cm-menu-scroller">
                <ul class="cm-menu-items">
                    <li class="cm-submenu">
                        <a class="sf-user-male-alt">Clients <span class="caret"></span></a>
                        <ul>
                    ...
                    <li class="cm-submenu">
                        <a class="sf-phone">Contracts<span class="caret"></span></a>
                        <ul>
                    ...
                    <li class="cm-submenu">
                        <a class="sf-post-it">Tariffs<span class="caret"></span></a>
                        <ul>
